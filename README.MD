...
![Static Badge](https://img.shields.io/badge/Java%20FX-17%2B-blue)
...
[//]: # (![img]&#40;github_samples/chat/chat_demo.png&#41;)
...
или запускать из IDE. Для запуска нескольких экземпляров приложения установить параметр<br>
